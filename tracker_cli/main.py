...
from tracker_cli.Src.Functions.Analysis.basic_df_analysis import hours_by_subject
# TODO
...
**********************************************************************
        ...
        user_dataframe, computation_df = json_to_user_dataframe(
            'tracker_cli/Src/UserData/records.json')

        with open('tracker_cli/Src/UserData/records.json') as f:
        ...
        # If the user inserts a subject, data, and time
            ...
            if 'n' in save_option:
                ...
                check_df = json_to_user_dataframe(
                    'tracker_cli/Src/UserData/records.json')[0]
                print(check_df.head())
